...
const resources = {
  en: {
    translation: {
      ...
      "tooltip.vendorId": "USB Vendor ID (e.g. 19D1 for LuatOS)",
      "tooltip.productId": "USB Product ID (e.g. 0001 for Air780E)",
      "tooltip.interfaceId": "Interface Number (MI) from PnpId (e.g. 02 for AT port)",
  ...
  zh: {
    translation: {
      ...
      "tooltip.vendorId": "USB 厂商 ID，例如合宙为 19D1",
      "tooltip.productId": "USB 产品 ID，例如 Air780E 为 0001",
      "tooltip.interfaceId": "PnpId 中的接口编号 (MI)，例如 02 通常为 AT 口",
